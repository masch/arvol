    ...
    before(async () => {
      ...
      const [_addresses, mockProofOfHumanity, mockPoster] = await Promise.all([
        ...
        waffle.deployMockContract(
          accounts[0],
          require("../artifacts/contracts/Arvol.sol/IProofOfHumanity.json").abi
        ),
        waffle.deployMockContract(
          accounts[9],
          require("../artifacts/contracts/Arvol.sol/IPoster.json").abi
        ),
      ]);
      ...
      altProofOfHumanity = await waffle.deployMockContract(accounts[0], require("../artifacts/contracts/Arvol.sol/IProofOfHumanity.json").abi);
